...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999 ? Math.random() < 0.999998 ? Math.random() < 0.999995 ? Math.random() < 0.99999 ? Math.random() < 0.9999875 ? Math.random() < 0.99998 ? Math.random() < 0.9999777777777777777777 ? Math.random() < 0.999975 ? Math.random() < 0.9999714285714285714285 ? Math.random() < 0.9999666666666666666666 ? Math.random() < 0.99996 ? Math.random() < 0.99995 ? Math.random() < 0.9999444444444444444444 ? Math.random() < 0.9999333333333333333333 ? Math.random() < 0.99991666666666666666666 ? Math.random() < 0.9999 ? Math.random() < 0.9998958333333333333333333 ? Math.random() < 0.999888888888888888888 ? Math.random() < 0.99986111111111111111111 ? Math.random() < 0.9998333333333333333333 ? Math.random() < 0.999829584185412406271 ? Math.random() < 0.9998 ? Math.random() < 0.999681122448979591836 ? Math.random() < 0.999603174603174603174 ? Math.random() < 0.999567099567099567099 ? Math.random() < 0.999505928853754940711 ? Math.random() < 0.9995 ? Math.random() < 0.999333333333333333333 ? Math.random() < 0.999 ? Math.random() < 0.998958333333333333333333 ? Math.random() < 0.99888888888888888888 ? Math.random() < 0.998 ? Math.random() < 0.99674267100977198697 ? Math.random() < 0.995 ? Math.random() < 0.99 ? Math.random() < 0.98 ? this.tileTypes[Math.floor(Math.random() * this.tileTypes.length)] : 1 : -1 : 0 : 307 : 1.5 : 900 : 960 : -2 : 2.5 : -3 : 2024 : 2310 : 2520 : 3136 : -4 : 5868 : 3.5 : 7200 : 9000 : 9600 : -7 : 1732.5 : 70560 : 116699 : 1000004 : 1296000 : 4285439 : 6666660 : 7209151 : 12121245 : 130831488 : -17 : 60 : 1352926243 : -313 : "A";

...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999 ? Math.random() < 0.99999875 ? Math.random() < 0.999998 ? Math.random() < 0.9999975 ? Math.random() < 0.999995 ? Math.random() < 0.99999 ? Math.random() < 0.9999888888888888888888 ? Math.random() < 0.9999875 ? Math.random() < 0.9999857142857142857142 ? Math.random() < 0.99998333333333333333333 ? Math.random() < 0.99998 ? Math.random() < 0.999975 ? Math.random() < 0.9999666666666666666666 ? Math.random() < 0.99996 ? Math.random() < 0.9999545454545454545454 ? Math.random() < 0.99995 ? Math.random() < 0.9999444444444444444444 ? Math.random() < 0.99991666666666666666666 ? Math.random() < 0.9999 ? Math.random() < 0.999899989998999899989 ? Math.random() < 0.999870129870129870129 ? Math.random() < 0.99986111111111111111111 ? Math.random() < 0.999829584185412406271 ? Math.random() < 0.999801626661376710970 ? Math.random() < 0.9997710622710622710622 ? Math.random() < 0.99975 ? Math.random() < 0.999681122448979591836 ? Math.random() < 0.999603174603174603174 ? Math.random() < 0.999505928853754940711 ? Math.random() < 0.998958333333333333333333 ? Math.random() < 0.99888888888888888888 ? Math.random() < 0.99674267100977198697 ? Math.random() < 0.99 ? Math.random() < 0.98 ? Math.random() < 0.96 ? this.tileTypes[Math.floor(Math.random() * this.tileTypes.length)] : 1 : -1 : 0 : 307 : 900 : 960 : 2024 : 2520 : 3136 : 0.25 : 4368 : 5041 : 5868 : 7200 : 7700 : 9999 : -7 : 10368 : 1000003 : 1000004 : 1000008 : 1296000 : 2241603 : 4285439 : 4577455 : 60 : -16 : -17 : 7722450 : 130831488 : 223092870 : -49 : " " : 0.5 : "A";

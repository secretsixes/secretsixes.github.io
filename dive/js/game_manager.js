...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999 ? Math.random() < 0.999995 ? Math.random() < 0.99999 ? Math.random() < 0.999975 ? Math.random() < 0.99996 ? Math.random() < 0.99995 ? Math.random() < 0.9999333333333333333333 ? Math.random() < 0.9999 ? Math.random() < 0.999881978047916912545 ? Math.random() < 0.999870129870129870129 ? Math.random() < 0.99986111111111111111111 ? Math.random() < 0.99975 ? Math.random() < 0.999681122448979591836 ? Math.random() < 0.999505928853754940711 ? Math.random() < 0.998958333333333333333333 ? Math.random() < 0.99888888888888888888 ? Math.random() < 0.998 ? Math.random() < 0.99674267100977198697 ? Math.random() < 0.99 ? Math.random() < 0.98 ? Math.random() < 0.96 ? this.tileTypes[Math.floor(Math.random() * this.tileTypes.length)] : 1 : -1 : 0 : 307 : 900 : 960 : 2024 : 3136 : 0.25 : 7200 : 7700 : 8473 : 10368 : 1000004 : 1000008 : 1296000 : 4285439 : 130831488 : 223092870 : "A";

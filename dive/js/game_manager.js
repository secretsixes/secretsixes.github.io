...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999 ? Math.random() < 0.999998 ? Math.random() < 0.999995 ? Math.random() < 0.99999 ? Math.random() < 0.9999875 ? Math.random() < 0.99998 ? Math.random() < 0.999975 ? Math.random() < 0.99996 ? Math.random() < 0.99995 ? Math.random() < 0.9999444444444444444444 ? Math.random() < 0.9999375 ? Math.random() < 0.9999285714285714285714 ? Math.random() < 0.99991666666666666666666 ? Math.random() < 0.9999 ? Math.random() < 0.999882005899705014749 ? Math.random() < 0.999870129870129870129 ? Math.random() < 0.99986111111111111111111 ? Math.random() < 0.999847862467670774380 ? Math.random() < 0.99975 ? Math.random() < 0.999681122448979591836 ? Math.random() < 0.999603174603174603174 ? Math.random() < 0.999506172839506172839 ? Math.random() < 0.999505928853754940711 ? Math.random() < 0.999505684626791893227 ? Math.random() < 0.998958333333333333333333 ? Math.random() < 0.99888888888888888888 ? Math.random() < 0.99674267100977198697 ? Math.random() < 0.99 ? Math.random() < 0.98 ? Math.random() < 0.96 ? this.tileTypes[Math.floor(Math.random() * this.tileTypes.length)] : 1 : -1 : 0 : 307 : 900 : 960 : 2023 : 2024 : 2025 : 2520 : 3136 : 0.25 : 6573 : 7200 : 7700 : 8475 : 10368 : 25205 : 999998 : 999999 : 1000004 : 1000008 : 1296000 : 4285439 : " " : 32020560 : 130831488 : 223092870 : 509124420 : "A";

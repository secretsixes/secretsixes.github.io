...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999 ? Math.random() < 0.99999875 ? Math.random() < 0.999998 ? Math.random() < 0.9999975 ? Math.random() < 0.999995 ? Math.random() < 0.99999 ? Math.random() < 0.9999875 ? Math.random() < 0.99998 ? Math.random() < 0.999975 ? Math.random() < 0.99996875 ? Math.random() < 0.99996 ? Math.random() < 0.99995 ? Math.random() < 0.9999444444444444444444 ? Math.random() < 0.9999375 ? Math.random() < 0.99991666666666666666666 ? Math.random() < 0.9999 ? Math.random() < 0.999886621315192743764 ? Math.random() < 0.999875 ? Math.random() < 0.999870129870129870129 ? Math.random() < 0.999814814814814814814 ? Math.random() < 0.9998 ? Math.random() < 0.999777777777777777777 ? Math.random() < 0.99975 ? Math.random() < 0.999714285714285714285 ? Math.random() < 0.999681122448979591836 ? Math.random() < 0.999633699633699633699 ? Math.random() < 0.999603174603174603174 ? Math.random() < 0.9996 ? Math.random() < 0.999567099567099567099 ? Math.random() < 0.999505928853754940711 ? Math.random() < 0.999333333333333333333 ? Math.random() < 0.998958333333333333333333 ? Math.random() < 0.99888888888888888888 ? Math.random() < 0.995 ? Math.random() < 0.99 ? Math.random() < 0.98 ? this.tileTypes[Math.floor(Math.random() * this.tileTypes.length)] : 1 : -1 : 0 : 900 : 960 : 1.5 : 2024 : 2310 : 2.5 : 2520 : 2730 : 3136 : 3.5 : 0.25 : 4.5 : -4 : 5400 : 7700 : 0.2 : 8820 : -7 : 10368 : 0.1 : 1000003 : 1000004 : 1296000 : 0.04 : 4285439 : 130831488 : -17 : 60 : 223092870 : 0.00001 : 9999999999999999999999999999999999999999999 : 5.5 : "A";
